  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full max-w-[1200px] gap-24 md:gap-28 lg:gap-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center group">
          <div className="flex justify-center order-1">
            <div className="bg-gradient-to-br from-primary-pr500 to-primary-pr600 rounded-2xl flex items-center justify-center overflow-hidden w-full max-w-[520px] min-h-[280px] transition-all duration-200 md:group-hover:-translate-y-1 md:group-hover:shadow-lg">
          ...
          <div className="flex flex-col gap-4 order-2 border border-neutral-n200 rounded-2xl p-6 shadow-sm w-full max-w-[520px] min-h-[280px] lg:min-h-[300px] transition-all duration-200 md:group-hover:-translate-y-1 md:group-hover:shadow-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center group">
          <div className="flex flex-col gap-4 order-2 lg:order-1 border border-neutral-n200 rounded-2xl p-6 shadow-sm w-full max-w-[520px] min-h-[280px] lg:min-h-[300px] transition-all duration-200 md:group-hover:-translate-y-1 md:group-hover:shadow-lg">
            <h3 className="font-dm-sans font-bold text-[28px] text-neutral-n1000">
