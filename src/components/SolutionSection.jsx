...
const SolutionSection = () => {
  return (
    <div id="how-it-works" className="bg-neutral-n0 box-border content-stretch flex flex-col gap-[var(--section-spacing-md,40px)] lg:gap-[var(--section-spacing-md,40px)] md:gap-[var(--section-spacing-sm,28px)] sm:gap-[var(--section-spacing-xs,20px)] items-center overflow-clip pb-[var(--section-spacing-xl,80px)] lg:pb-[var(--section-spacing-xl,80px)] md:pb-[var(--section-spacing-lg,60px)] sm:pb-[var(--section-spacing-md,48px)] pt-6 lg:pt-8 md:pt-6 sm:pt-4 px-[var(--inset-3xl,32px)] lg:px-[var(--inset-3xl,32px)] md:px-[var(--inset-xl,20px)] sm:px-[var(--inset-lg,16px)] relative shrink-0 w-full max-w-[1440px] scroll-mt-[96px] md:scroll-mt-[112px]">
      {/* Header Section */}
